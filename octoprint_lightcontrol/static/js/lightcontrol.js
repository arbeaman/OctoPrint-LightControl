// Nav bar and settings view model for Light Control. Reflects the current state in the nav
...
$(function() {
    function LightControlViewModel(parameters) {
        ...
        self.onStartup = function() {
            ...
            OctoPrint.simpleApiGet("lightcontrol").done(function(data) {
        ...
        self.turnLightOn = function() {
            OctoPrint.simpleApiCommand("lightcontrol", "turnLightOn");
        };

        self.turnLightOff = function() {
            OctoPrint.simpleApiCommand("lightcontrol", "turnLightOff");
        };
    ...
    OCTOPRINT_VIEWMODELS.push({
        ...
        elements: ["#navbar_plugin_lightcontrol", "#settings_plugin_lightcontrol"]
    });
});
